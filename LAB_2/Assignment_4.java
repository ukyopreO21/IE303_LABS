...
class GamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    public GamePanel() {
        ...
        Timer pipeTimer = new Timer(1500, e -> {
            if (!gameOver)
                placePipes();
        });
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.drawString("Press ENTER or SPACE to restart", 40, 300);
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (!gameOver) {
            ...
            if (bird.y + bird.height > FlappyBird.HEIGHT - groundHeight) {
                gameOver = true;
                bird.y = FlappyBird.HEIGHT - groundHeight - bird.height;
            }
